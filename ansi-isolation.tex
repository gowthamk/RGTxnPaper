...
defined similarly.  $T_i \usesar X$ if it reads or writes $X$.
...
witness $T_i$. Specification of ANSI SQL \iso{Repeatable Read}
...
does not guarantee total order of transactions w.r.t. $\visZ$ because,
in reality, databases do not guarantee serializable execution unless
\emph{all} transactions choose {\sc ser}.
