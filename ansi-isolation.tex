...
$\mathtt{AtomicVis}$ and $\mathtt{CommitVis}$ guarantees. {\sc rc}
...
witness $T_i$. The specification of\iso{Repeatable Read} ({\sc rr})
...
when it committed. Lastly, \iso{Serializable} isolation extends
