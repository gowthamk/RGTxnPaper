...
isolation level called \emph{Monotonic Atomic View} (\C{MAV} of
...
setting\footnote{On the other hand, Fig.~\ref{fig:ansi-isolation}
presents slightly weaker versions of \C{SI} and \C{SER} specs in the
interest of clarity.}.
