...
proof system for concurrent imperative programs with weakly isolated
transactions (\txnimp programs, as we call them).  Our operational
model captures all the behaviors exhibited by a program under weak
isolation without referring to any specific implementation of
isolation. Our proof system enables formal reasoning about program
invariants while taking into account the fine-grained isolation
semantics of transactions. Case studies demonstrate the utility of our
approach.
\end{abstract}
