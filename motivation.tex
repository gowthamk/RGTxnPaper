...
uncommitted transaction. \iso{Snapshot Isolation} admits interference
...
Fig.~\ref{fig:interference-ex}.  \iso{Read Committed} specification
...
and only a subset of the operations in \C{Wd1}. Ligher (blue) arrows with
