...
modify the record by incrementing its \C{d\_next\_o\_id} field,
...
\C{new\_order} transactions that write to a different district record. 
Fortunately, such interference does not prompt \C{new\_order} to
