...
language equipped with a \C{txn} lexical block for transactions. Each
...
Let us consider \iso{Read Committed} (RC), a weak isolation level
...
anomaly}~\cite{berenson}), resulting in a balance of \C{k-a1}. The
...
\iso{Snapshot Isolation} (SI)~\cite{berenson} fits this requirement by
