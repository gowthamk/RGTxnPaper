...
programmers to understand low-level implementation details
...
characteristic as constraints over the $\hbZ$ relation. However, for
...
(e.g., eventually consistent), and should be able to reconcile
