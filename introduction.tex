...
error prone endeavor, with major database vendors continuing to
...
isolation level may induce, placing the burden squarely on the
programmer to determine application correctness.
...
parameterized over different isolation notions. \S\ref{sec:proofrules}
formalizes the proof systemt that we use to reason about program
