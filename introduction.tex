...
isolated \iso{read committed} isolation level - the default level for
...
constraint. Bailis \empH{et al.}~\cite{bailisferal} rely on Rails's
...
Our semantic framework and proof methodology thus provide the first
