...
different contemporary states (or different replicas) of the database
which, although consistent individually, may not be obviously
reconciled into a consistent global view. Furthermore, operations may
temporarily break invariants as long as transaction as a whole
preserves them.  Intuitively, the latter problem reduces to the former
if all transactions contain a single operation. Furthermore, weak
isolation can exist independent of weak consistency, as evident from
the presence of weakly isolated transactions on sequentially
...
reasoning frameworks developed for weak consistency in new and
important ways.
