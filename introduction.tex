...
endeavour, with major database vendors~\cite{postgresiso, mysqliso,
...
invariants when executed on a store equipped with appropriate consistency
guarantees.  The paper makes the following contributions:
\vspace*{-6pt}
\begin{enumerate}
