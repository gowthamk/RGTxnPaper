...
satisfy \C{SC}. This approach hints at a general solution reconciling
...
Applying maximum visibility principle, we weaken \C{SC} to obtain the
...
store is the \C{CC} guarantee that requires an effect to witness all
