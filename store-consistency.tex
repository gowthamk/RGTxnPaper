...
a special case. In this section, we explain how our reasoning approach
works under weakly consistent replication by comparing our model with
the standard model of replication.

Reasoning about eventually consistent replication often involves
