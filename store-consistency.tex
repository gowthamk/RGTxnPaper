...
Reasoning about weakly-consistent replication involves reasoning in
...
RHS expression \C{C-a2}.  Assertions implicitly refer to the current
...
that all the effects added by $R_1$ are of \C{Wd2}. This is
needed to prove that an interference from \C{Wd2} does effect the
local state of \C{Wd1}.
