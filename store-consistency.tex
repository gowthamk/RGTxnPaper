...
to multiple semantic definitions and proof systems with no obvious to
compare and relate them.  Having a parameterized semantics and proof
framework built on the framework defined above allows us to support
these variants as distinct, yet comparable instantiations, thus
avoiding the need for semantics re-engineering every time an
