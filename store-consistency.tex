...
the maximal visibility weakening (Def.~\ref{def:maxvis}) of {\sc sc}
...
assertions is drawn from linear arithmetic, which is also decidable.
Consequently, the proof obligations generated by the application of
our rules can often be discharged via an SMT solver. 
