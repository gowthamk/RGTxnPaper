...
\eta &  \in & \mathtt{Effect} & \coloneqq & (\C{Txn}_i,j,\op,\mathbb{N})\\
...
{
  \I \vdash (\mathcal{F},(\A,\visZ)) \tstepsto (v,\E')
}
\end{array}
\end{smathpar}
\end{minipage}
...
\RULE
{
  ...
  \underI{(\mathcal{F},\E) \tstepsto (v,\E')}
}
{
...
\RULE
{
  ...
  \underI{(\mathcal{F},\E) \tstepsto (\bot,\E')}
}
{
