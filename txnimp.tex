...
&&&&\ALT \stxn{i}{\I}{ c } \ALT \ctxn{i}{\I,\stl,\stg}{c} \ALT c1 || c2\\
...
\begin{minipage}{3in}
  ...
  \begin{array}{c}
    \RULE{}
         {(\stxn{i}{\I_e}{c},\stg) \stepsto (\ctxn{i}{\I_e,\emptyset,\stg}{c},\stg)}
  \end{array}
  \end{smathpar}
\end{minipage}%
\hfill
...
{
  (\ctxn{i}{\I_e,\stl,\stg}{c},\stg') \stepsto
  (\ctxn{i}{\I_e,\stl',\stg'}{c'},\stg')
}
\end{array}
\end{smathpar}
\end{minipage}\\
...
{
  (\ctxn{i}{\I_e,\stl,\stg}{\cskip},\stg') \stepsto (\cskip,\stl\gg\stg')
}
\end{array}
\end{smathpar}
\end{minipage}
