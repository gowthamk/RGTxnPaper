...
below) is not a transitive relation, hence lets us capture finer
properties than $\hbZ$. We therefore let $\visZ$ replace $\hbZ$ in our
discussion henceforth. The session order relation captures the
...
$\id(\eta) > \maxId(\A)$ condition of \rulelabel{E-Aux}. Evaluation
