...
as described in (Sec.~\ref{sec:motivation}), an SI transaction on
...
presented in the next section; the automation framework introduced in
Sec.~\ref{sec:inference}, however, has a non-trivial dependence on
