...
command $c$ is executed in a state that satisfies its pre-condition
...
state of execution satisfies the post-condition $Q$. The terms
...
the trace invariant $\I$ for the post-condition to be valid.  As usual,
