...
inside \C{Wd1} described abstractly in \S\ref{sec:motivation}, and
...
generate \C{RD} effects), and admit interference during their
...
The three \rulelabel{RG-Conseq} rules define ways to strengthen or
...
\GK{Here, I give intuitive explanation of soundness in the context of
EC replication. This answers Gustavo's question of why Gotsman-like
special case reasoning about replicas is not needed in our setting.}
