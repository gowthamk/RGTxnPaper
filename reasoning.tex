...
% (\eg~\C{X$\ge$0}) and trace invariants (\eg~$\I =
...
% \C{B} is \C{k-a1-a2}. The equivalent execution-based assertion
% ($\lambda\E.~\interp{\E.\A}(\C{B})\,=\,\C{k-a1-a2}$) asserts that in
% all executions of the program, the value of \C{B} is \C{k-a1-a2}.
