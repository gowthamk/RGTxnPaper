...
parameterized on a weak isolation specification $\I$. $\I$ can be
...
uncommitted transaction, but not prohibiting insertion of new
...
and flush ($\gg$) should only flush the records that bear the current
