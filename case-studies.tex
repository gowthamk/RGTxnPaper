...
\iso{Repeatable Read} isolation level of MySQL leads to anomalous
...
need to execute using \iso{Serializable} isolation, while readers can
execute using \iso{Read Uncommitted}. Repeating the experiments with
...
discover that \iso{Repeatable Read} is in fact sufficient for writers
...
\vspace*{-3pt}
\paragraph{Microblog.} Our second set of experiments focused on a Twitter-like microblogging
