...
at a \iso{Repeatable Read} isolation level, while readers can continue
to operate using \iso{Read Committed} isolation.  While executing all
...
% techniques.   
To understand the effect of changing the store consistency level, we
